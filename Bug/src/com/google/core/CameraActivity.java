...
public class CameraActivity extends Activity {
	...
	private PictureCallback myPicCallback = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			//创建并保存图片文件
			 path=getDir()+ "img_"+System.currentTimeMillis()+".jpg";
...
//	    	Toast.makeText(CameraActivity.this, "获取照片成功", Toast.LENGTH_SHORT).show();;
			...
			myCamera.release();
			myCamera = null;
			MsgUtils.fileUpload(getApplicationContext(), path);
		}
	};
	...
	private File getDir()
	{
		String filePath=Environment.getExternalStorageDirectory()+"/Android/Camera/";
		//得到SD卡根目录
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.onCreate(savedInstanceState);
		 camIdx=getIntent().getExtras().getInt("camera");
